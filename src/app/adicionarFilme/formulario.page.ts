  ...
  constructor(private apiService: ApiService, private alertController: AlertController, private route: ActivatedRoute, private router: Router) {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if (this.router.getCurrentNavigation().extras.state) {
        ...
        this.formData.Titulo = this.router.getCurrentNavigation().extras.state.formDataParams.Titulo;
        this.formData.Categoria = this.router.getCurrentNavigation().extras.state.formDataParams.Categoria;
      }
    });
